...
const StudentSidebar = ({ activeTab, setActiveTab, currentUser, onLogout, isOpen = false, onClose }) => {
    ...
    const renderMenuItem = (item, isSub = false) => {
        ...
        const isOpenSub = openMenus.includes(item.id);
        ...
        return (
            <div key={item.id} className="w-full">
                ...
                >
                    ...
                    {hasChildren && (
                        isOpenSub ? <ChevronDown size={14} className="opacity-50" /> : <ChevronRight size={14} className="opacity-50" />
                    )}
                </button>
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 flex flex-col relative z-10 h-full">
                {/* Brand Header */}
                <div className="h-16 lg:h-20 flex items-center justify-between px-6 lg:px-8 border-b border-white/5 bg-white/5 backdrop-blur-md">
                ...
                <div className="flex-1 px-4 space-y-1 overflow-y-auto custom-scrollbar pb-6 mt-6">
                    <div className="text-[9px] font-black text-gray-500 uppercase tracking-[0.25em] px-4 mb-3">
                        Main Menu
                    </div>
                ...
                {/* User Profile & Logout */}
                <div className="p-4 border-t border-white/5 bg-black/10 backdrop-blur-md mt-auto">
                    <div className="flex items-center gap-3 mb-3">
                        <div className="w-9 h-9 rounded-full bg-[#4c84ff]/20 border border-[#4c84ff]/30 flex items-center justify-center font-bold text-sm text-[#93c5fd] shrink-0">
                ...
                <div className="p-4 border-t border-white/5 hidden sm:block">
                    <div className="py-2 bg-[#4c84ff]/10 rounded-xl border border-[#4c84ff]/20">
                        <p className="text-[9px] text-[#93c5fd] font-bold uppercase tracking-wider text-center m-0">
